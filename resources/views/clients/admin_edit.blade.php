                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6 offset-xl-2">
                                    <form id="basic-form" action="{{ route('clients.admin_update',$client['id']) }}" method="post" enctype="multipart/form-data">
                                        @csrf

                                        <div class="mb-3 row">
                                            <label class="col-md-3 col-form-label">Client Name<span style="color:red;font-weight:bold;">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" name="name" autocomplete="off" value="{{$client['name']}}" class="form-control" />
                                                @error('name')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="email" autocomplete="off" value="{{$client['email']}}" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="mobile" autocomplete="off" value="{{$client['mobile']}}" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="country" autocomplete="off" value="{{$client['country']}}" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="state" autocomplete="off" value="{{$client['state']}}" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="district" autocomplete="off" value="{{$client['district']}}" class="form-control" />
                                            </div>
                                        </div>
