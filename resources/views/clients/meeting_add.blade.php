                ...
                <div class="offset-md-3 col-6 offset-md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="mb-0 text-uppercase">Add Client Meeting Schedule Details</h6>
                            <hr>
                            <form action="{{ route('clients.meeting_store') }}" method="post">
                            @csrf
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <input type="text" class="form-control" name="mobile_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10">
                                        @error('mobile_number')
                                        <div class="text text-danger">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <div class="input-group" id="datepicker1">
                                            <input type="text" class="form-control" name="date" data-date-container='#datepicker1' data-provide="datepicker" data-date-autoclose="true">
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <div class="input-group" id="timepicker1">
                                            <input type="text" class="form-control" name="time" data-date-container='#timepicker1' data-provide="timepicker">
